...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=50, verbose_name='имя/название огранизации')),
                ('email', models.EmailField(max_length=254, verbose_name='email')),
                ('phone', models.CharField(max_length=15, verbose_name='телефон')),
                ('object_id', models.PositiveIntegerField(editable=False, null=True)),
                ('build_object', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='tracker.buildobject', verbose_name='объект')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('client_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='tracker.client')),
                ('reprasintative_name', models.CharField(max_length=100, verbose_name='имя представителя')),
